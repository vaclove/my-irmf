...
router.post('/', async (req, res) => {
  try {
    const { first_name, last_name, email, phone, language, company, notes, greeting } = req.body;
    ...
    const result = await pool.query(
      `INSERT INTO guests (first_name, last_name, email, phone, language, company, notes, greeting, greeting_auto_generated) 
       VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) 
       RETURNING *`,
      [first_name, last_name, email, phone, guestLanguage, company, notes, finalGreeting, greetingAutoGenerated]
    );
